...
# cd AgentGym-RL 73 77 73.4
# source activate 
# conda activate agentgym-rl sh examples/eval/sciworld_eval.sh
# cp -r /home/hly/projects/AgentGEPO/saves/agentgym_rl_7b_qapo_base_55001tok-75 /gpfs-share/gfshome-2025xx/s202517/hly/
export VLLM_ATTENTION_BACKEND=XFORMERS
...
ckpt_path="/home/hly/projects/AgentGEPO/saves/agentgym_rl_7b_qapo_base_55001tok/global_step_200/actor"
...
HYDRA_FULL_ERROR=1 python3 -m verl.agent_trainer.main_generation  \
    data.path=/home/hly/projects/AgentGEPO/AgentItemId/eval \
